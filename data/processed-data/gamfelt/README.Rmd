...
## File structure
 ...
 - `README-catchment-covariates.txt` - description of each variable in the catchment descriptor dataset.
 - `gamfelt_descriptive_table.xlsx` - summary table matching Table A2 in report [2016:85](https://asp.bibliotekservice.no/nve/title.aspx?tkey=23147).
