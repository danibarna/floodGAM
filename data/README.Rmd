...
The archive cross-check criteria systematically removes some problematic years, but will not catch all issues. External knowledge about a station's reliability can help in manually validating and removing problematic data if necessary.
