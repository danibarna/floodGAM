...
The stations are a subset of those in NVE-rapport 2016:85 [Flomdata: utvalg og kvalitetssikring av flomdata for flomfrekvensanalyser](https://asp.bibliotekservice.no/nve/title.aspx?tkey=23147) that have suitable sub-daily sampling frequency around annual maxima. 
...
Den komplette vannførings tidsserien for hver stasjon er tilgjengelig på NVE-serveren på (link). Databasekommandoer for å hente data fra HYDRA II er tilgjengelige [her](/data/raw-data/), sammen med en bruksanvisning [her](/data/how-to/hvordan_henter_jeg_data_med_lescon_var.md). All kode for rensing og kvalitetskontroll av rå vannføringsdata er tilgjengelig [her](/code/data-creation/).
