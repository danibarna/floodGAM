...
The data pipeline is the process of building the `gamfelt` dataset from the raw streamflow data provided by NVE. The "findata quality control" step is described in the following section.
