...
Den komplette vannførings tidsserien for hver stasjon er tilgjengelig på NVE-serveren på (link). Databasekommandoer for å hente data fra HYDRA II er tilgjengelige [her](/data/raw-data/), sammen med en bruksanvisning [her](/data/how-to/). All kode for rensing og kvalitetskontroll av rå vannføringsdata er tilgjengelig [her](/code/data-creation/).
